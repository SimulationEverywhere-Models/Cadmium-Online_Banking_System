...
int main(){
  ...
  const char * i_input_data = "../input_data/PV_input_test.txt";
...
dynamic::modeling::Ports iports_TOP = {};
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader, PV1};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<PasswordVerifier_defs::Output_OUT,outp_output>("PV1"),
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,PasswordVerifier_defs::Input_IN>("input_reader","PV1"),
...
static ofstream out_messages("../simulation_results/PV_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/PV_test_output_state.txt");
